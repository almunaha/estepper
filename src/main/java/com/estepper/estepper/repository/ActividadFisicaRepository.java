...
public interface ActividadFisicaRepository extends JpaRepository<ActividadFisica, Integer> {
     ...
     void updateActividadFisica(Integer vecesafv, Integer horaafv, Integer minafv, Integer metsafv, Integer vecesafm,
               Integer horaafm, Integer minafm, Integer metsafm, Integer vecescaminar, Integer horacaminar,
               Integer mincaminar, Integer metscaminar, Integer horasentado, Integer minsentado, Integer metstotales,
               String clasificacion, Participante participante);
