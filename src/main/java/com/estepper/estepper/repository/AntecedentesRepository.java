...
public interface AntecedentesRepository extends JpaRepository<Antecedentes, Integer> {
     ...
     void updateAntecedentes(String hta, String tiroides, String patmental, String dislipemias, String patmuscesq,
               String medicacion, String ecv, String patsensorial, String especificar, String fuma, String dejardefumar,
               Integer tasistolica, Integer tadiastolica, Participante participante);
