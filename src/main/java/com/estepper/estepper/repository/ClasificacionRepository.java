...
public interface ClasificacionRepository extends JpaRepository<Clasificacion, Integer> {
     ...
     void updateClasificacion(String analiticahecha, Integer glucemia, Integer colesterol, Integer ldl, Integer sog,
               Integer hdl, Integer trigliceridos, double hbA1c, String pediranalitica, Integer clasificacionusuario,
               String montesa, String motivomontesa, String taller, String motivotaller, String actividadfisica,
